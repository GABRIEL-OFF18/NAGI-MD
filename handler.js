...
// --- INICIO DEL SISTEMA DE BIENVENIDA INTEGRADO ---
// Ejecutar el handler de bienvenida y despedida
try {
    const { handler: welcomeHandler } = await import('./_welcome.js')
    await welcomeHandler.call(this, m, { conn: this, chat, user })
} catch (e) {
    console.error('[WELCOME] Error al ejecutar el handler de bienvenida:', e)
}
// --- FIN DEL SISTEMA DE BIENVENIDA INTEGRADO ---
...
const msg = {
    ...
    premium: '*\˙˚ʚ₍ ᐢ.💎.ᐢ ₎ɞ˚ ᥱs𝗍ᥱ ᥴ᥆mᥲᥒძ᥆ s᥆ᥣ᥆ sᥱ ⍴ᥙᥱძᥱ ᥙ𝗍іᥣіzᥲr ⍴᥆r ᥙsᥙᥲrі᥆s ⍴rᥱmіᥙm, ᥡ ⍴ᥲrᥲ mі ᥴrᥱᥲძ᥆.\*',
